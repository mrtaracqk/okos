...
import { type WorkerRequestMode } from '../contracts/workerRequest';
...
export function buildNoToolCallFailure(workerName: CatalogWorkerToolName, task: string, mode: WorkerRequestMode): ToolRun {
  return {
